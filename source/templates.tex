...
\tcode{<>} (or an equivalent template alias specialization).
If the $n$th template parameter is
a parameter pack, the $n$th template argument is a pack
...
If the $n$th template parameter is a template
parameter pack~(\ref{temp.variadic}), the $n$th template argument is a pack
expansion~(\ref{temp.variadic}) whose pattern is the name of
