...
%\newcommand{\capsep}{\hline\hline}
 \newcommand{\capsep}{\xEmpty{capsep}}
...
%\newcommand{\hdstyle}[1]{\textbf{##1}}				% set header style
 \newcommand{\hdstyle}[1]{##1}				% set header style
...
%\newcommand{\br}{\hfill\break}						% force newline within table entry
 \newcommand{\br}{\xEmpty{br}}						% force newline within table entry
...
% dyp: I struggled a bit with this one, since LXir does quite a good job at tagging
% normal tables. So I just replaced the longtable with a normal tabular and provided extra
% macros for the longtable extensions.
\newenvironment{LongTable}[3]
{
%\newcommand{\continuedcaption}{\caption[]{#1 (continued)}}
 \newcommand{\continuedcaption}{\xBegin{continuedcaption}#1\xEnd{continuedcaption}}
 \renewcommand{\endfirsthead}{\xEmpty{endFirstHead}}
 \renewcommand{\endhead}{\xEmpty{endHead}}
 \begin{TableBase}
%\begin{longtable}
%{|#3|}\caption{#1}\label{#2}
 \begin{table}
