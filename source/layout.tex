...
%}}}
% dyp: lxir version;
%      had problems with expansion of \value
\newcommand{\parabullnum}[2]{%
\stepcounter{#1}%
\xEmptyA{number}{value=%
\ifnum \arabic{Paras}>0
\arabic{Paras}%
\ifnum \arabic{Bullets1}>0 .\arabic{Bullets1}%
\ifnum \arabic{Bullets2}>0 .\arabic{Bullets2}%
\ifnum \arabic{Bullets3}>0 .\arabic{Bullets3}%
\fi\fi\fi%
\fi%
}%
}
