...
% dyp: fancy formatting not required
...
% dyp: more fancy formatting. IIRC, I replaced longtable,
%      so the makecaption customization shouldn't be required either
...
\setcounter{secnumdepth}{5} % dyp: this seems to necessary because of the new document class
